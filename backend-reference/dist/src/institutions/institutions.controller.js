...
let InstitutionsController = class InstitutionsController {
    ...
    findOne(id) { return this.institutionsService.findOne(id); }
    create(dto) { return this.institutionsService.create(dto); }
    update(id, dto) {
        return this.institutionsService.update(id, dto);
    }
    remove(id) { return this.institutionsService.remove(id); }
};
