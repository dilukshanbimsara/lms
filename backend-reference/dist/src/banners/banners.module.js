...
const banners_public_controller_1 = require("./banners-public.controller");
let BannersModule = class BannersModule {
};
exports.BannersModule = BannersModule;
exports.BannersModule = BannersModule = __decorate([
    (0, common_1.Module)({
        controllers: [banners_controller_1.BannersController, banners_public_controller_1.BannersPublicController],
