...
let UsersService = class UsersService {
    ...
    async create(dto) {
        ...
        if (role === 'TEACHER' && count >= 1) {
            throw new common_1.ConflictException('A teacher account already exists. Only one teacher is allowed.');
        }
        if (role === 'SUPER_ADMIN' && count >= 1) {
            throw new common_1.ConflictException('A super admin account already exists. Only one super admin is allowed.');
        }
